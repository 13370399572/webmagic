...
public class FilmSpiderStart {
   ...
   @Scheduled(cron = "* 0-30 9 * * ?")
    ...
    public void zhangstart() {
    	zhang();
    	/*zhang1();*/
    }
    
  /*  @Scheduled(fixedRate=100000)
    public void zhangstart1() {
    	
    }*/
    
    
    private void zhang() {
    	Spider.create(sligerPageProcessor).addUrl("https://music.163.com/m/discover/toplist").addPipeline(slingerPipeline).thread(5).run();
