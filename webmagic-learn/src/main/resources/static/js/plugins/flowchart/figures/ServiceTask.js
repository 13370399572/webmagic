...
com.mvr.unfetter.domain.workflow.ServiceTaskICON = draw2d.shape.icon.Run.extend({
...
com.mvr.unfetter.domain.workflow.ServiceTaskText = draw2d.shape.basic.Text.extend({
...
com.mvr.unfetter.domain.workflow.ServiceTask = draw2d.shape.basic.Rectangle.extend({
	NAME: "com.mvr.unfetter.domain.workflow.ServiceTask",
	init: function(){
		this._super();
		...
		var ServiceTaskICON = new com.mvr.unfetter.domain.workflow.ServiceTaskICON();
		var ServiceTaskText = new com.mvr.unfetter.domain.workflow.ServiceTaskText("服务任务");
