...
/*
com.mvr.unfetter.domain.workflow.ManualTaskICON = draw2d.shape.icon.User.extend({
	NAME: "ManualTaskICON",
...
com.mvr.unfetter.domain.workflow.ManualTaskICON = draw2d.SetFigure.extend({
	NAME: "ManualTaskICON",
...
com.mvr.unfetter.domain.workflow.ManualTaskText = draw2d.shape.basic.Text.extend({
	NAME: "ManualTaskText",
...
com.mvr.unfetter.domain.workflow.ManualTask = draw2d.shape.basic.Rectangle.extend({
	NAME: "com.mvr.unfetter.domain.workflow.ManualTask",
	init: function(){
		this._super();
		...
		var manualTaskICON = new com.mvr.unfetter.domain.workflow.ManualTaskICON();
		var manualTaskText = new com.mvr.unfetter.domain.workflow.ManualTaskText("手工任务");
