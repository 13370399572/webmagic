 ...
 * @date 2014-12-09
 */
com.mvr.unfetter.domain.workflow.Canvas = draw2d.Canvas.extend({
	canvasName: "com.mvr.unfetter.domain.workflow.Canvas",
	...
	init: function(id){
		...
		var MyInterceptorPolicy = draw2d.policy.canvas.ConnectionInterceptorPolicy.extend({
			...
			delegateDrop: function(draggedFigure, dropTarget){
				if(draggedFigure instanceof com.mvr.unfetter.domain.workflow.UserTask && dropTarget instanceof com.mvr.unfetter.domain.workflow.Connection){
					return dropTarget;
				}
