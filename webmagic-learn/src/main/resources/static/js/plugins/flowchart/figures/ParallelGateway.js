...
com.mvr.unfetter.domain.workflow.ParallelGatewayICON = draw2d.shape.icon.Plus.extend({
...
com.mvr.unfetter.domain.workflow.ParallelGateway = draw2d.shape.basic.Diamond.extend({
	NAME: "com.mvr.unfetter.domain.workflow.ParallelGateway",
//	NAME: "com.mvr.unfetter.domain.workflow.ParallelGateway",
	init: function(){
		this._super();
		...
		var ParallelGatewayICON = new com.mvr.unfetter.domain.workflow.ParallelGatewayICON();
