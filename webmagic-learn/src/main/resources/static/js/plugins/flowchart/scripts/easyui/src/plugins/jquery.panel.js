...
(function($) {
        ...
        function _24() {
            if (_22.noheader || (!_22.title && !_22.header)) {
                ...
                if (_22.header) {
                    ...
                    if (_22.minimizable) {
                        _2c(_2b, "panel-tool-min",
                        function() {
                            _62(_20);
                        });
                    }
                    if (_22.maximizable) {
                        _2c(_2b, "panel-tool-max",
                        function() {
    ...
    function _43(_50, _51) {
        ...
        if (_51 == true) {
            if (_52.halign == "left" || _52.halign == "right") {
                _53.animate({
                    width: _55._outerWidth() + _53.children(".panel-footer")._outerWidth()
                },
                function() {
                    cb();
                });
    ...
    $.fn.panel = function(_70, _71) {
        ...
        return this.each(function() {
            ...
            if (_72) {
                ...
                _73 = $.extend({},
                $.fn.panel.defaults, $.fn.panel.parseOptions(this), _70);
                $(this).attr("title", "");
                _72 = $.data(this, "panel", {
                    options: _73,
                    panel: _1b(this),
    ...
    $.fn.panel.parseOptions = function(_84) {
        ...
        return $.extend({},
        $.parser.parseOptions(_84, ["id", "width", "height", "left", "top", "title", "iconCls", "cls", "headerCls", "bodyCls", "tools", "href", "method", "header", "footer", "halign", "titleDirection", {
            cache: "boolean",
            fit: "boolean",
            border: "boolean",
            noheader: "boolean"
