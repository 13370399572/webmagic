...
com.mvr.unfetter.domain.workflow.ScriptTaskICON = draw2d.SetFigure.extend({
	NAME: "ScriptTaskICON",
...
com.mvr.unfetter.domain.workflow.ScriptTaskText = draw2d.shape.basic.Text.extend({
	NAME: "ScriptTaskText",
...
com.mvr.unfetter.domain.workflow.ScriptTask = draw2d.shape.basic.Rectangle.extend({
	NAME: "com.mvr.unfetter.domain.workflow.ScriptTask",
	init: function(){
		this._super();
		...
		var scriptTaskICON = new com.mvr.unfetter.domain.workflow.ScriptTaskICON();
		var scriptTaskText = new com.mvr.unfetter.domain.workflow.ScriptTaskText("脚本任务");
