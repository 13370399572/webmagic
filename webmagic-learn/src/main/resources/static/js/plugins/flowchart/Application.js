...
com.mvr = {};
com.mvr.unfetter = {};
com.mvr.unfetter.domain = {};
com.mvr.unfetter.domain.workflow = {};
 ...
 *  @date 2014-12-03
 */
com.mvr.unfetter.domain.workflow.Application = Class.extend({
	appName: "com.mvr.unfetter.domain.workflow.Application",
	/**
	 * @constructor
	 * 
	...
	init: function(canvasID){
		...
		this.canvas = new com.mvr.unfetter.domain.workflow.Canvas('activitiCanvas');
		
		//-- 2. activiti-designer的连接器(全局)
		draw2d.Connection.createConnection = this.createConnection;
		
		//-- 3. activiti-designer的手风琴导航菜单
		this.accordion = new com.mvr.unfetter.domain.workflow.Accordion(this.canvas);
		
		//-- 4. activiti-designer的工具条
		this.toolbar = new com.mvr.unfetter.domain.workflow.ToolBar(this.canvas);
	...
	loadFigure: function(){
		...
		this.canvas.add(new com_mvr_unfetter_domain_workflow_Start(),200,80);
		// this.canvas.add(new com.mvr.unfetter.domain.workflow.End(),350,250);
