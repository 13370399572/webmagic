 ...
 * @date 2014-12-09
 */
com.mvr.unfetter.domain.workflow.Accordion = Class.extend({
	accordionName: "com.mvr.unfetter.domain.workflow.Accordion",
	...
	init: function(view){
		...
		$('#'+view.id).droppable({
			...
			onDrop: function(e,source){
				...
				var shape = eval("new com.mvr.unfetter.domain.workflow."+nodeType+"()");
				//view.add(shape,x,y);
