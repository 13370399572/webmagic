...
com.mvr.unfetter.domain.workflow.ExclusiveGatewayICON = draw2d.shape.icon.Cross.extend({
...
com.mvr.unfetter.domain.workflow.ExclusiveGateway = draw2d.shape.basic.Diamond.extend({
	NAME: "com.mvr.unfetter.domain.workflow.ExclusiveGateway",
//	NAME: "com.mvr.unfetter.domain.workflow.ExclusiveGateway",
	init: function(){
		this._super();
		...
		var ExclusiveGatewayICON = new com.mvr.unfetter.domain.workflow.ExclusiveGatewayICON();
