...
(function($) {
    function _1(_2) {
        ...
        $(_2).addClass("spinner-f").textbox($.extend({},
        _4, {
            icons: _5,
            doSize: false,
        ...
        return this.each(function() {
            ...
            if (_1a) {
                ...
                _1a = $.data(this, "spinner", {
                    options: $.extend({},
                    $.fn.spinner.defaults, $.fn.spinner.parseOptions(this), _17)
                });
            }
            _1(this);
        });
    ...
    $.fn.spinner.parseOptions = function(_1c) {
        return $.extend({},
        $.fn.textbox.parseOptions(_1c), $.parser.parseOptions(_1c, ["min", "max", "spinAlign", {
            increment: "number",
            reversed: "boolean"
        }]));
    };
